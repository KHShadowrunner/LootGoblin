...
public static class TreasureMapData
{
    public static readonly Dictionary<uint, TreasureMapInfo> KnownMaps = new()
    {
        ...
        { 12243, new TreasureMapInfo { ItemId = 12243, Name = "Timeworn Dragonskin Map", Tier = MapTier.Party, MinLevel = 60, Expansion = "HW", HasDungeon = true, Category = MapCategory.Dungeon, Status = ImplementationStatus.NotStarted, DungeonTerritoryId = 558, InstanceName = "The Aquapolis" } },
        ...
        { 26745, new TreasureMapInfo { ItemId = 26745, Name = "Timeworn Zonureskin Map", Tier = MapTier.Party, MinLevel = 80, Expansion = "ShB", HasDungeon = true, Category = MapCategory.Roulette, Status = ImplementationStatus.WIP, DungeonTerritoryId = 879, InstanceName = "The Dungeons of Lyhe Ghiah" } },
        { 33328, new TreasureMapInfo { ItemId = 33328, Name = "Ostensibly Special Timeworn Map", Tier = MapTier.Party, MinLevel = 80, Expansion = "ShB", HasDungeon = true, Category = MapCategory.GuaranteedPortal, Status = ImplementationStatus.WIP, DungeonTerritoryId = 879, InstanceName = "The Dungeons of Lyhe Ghiah", SecondInstanceName = "The Shifting Oubliettes of Lyhe Ghiah", SecondTerritoryId = 924 } },
        ...
        { 36612, new TreasureMapInfo { ItemId = 36612, Name = "Timeworn Kumbhiraskin Map", Tier = MapTier.Party, MinLevel = 90, Expansion = "EW", HasDungeon = true, Category = MapCategory.Roulette, Status = ImplementationStatus.WIP, DungeonTerritoryId = 1000, InstanceName = "The Excitatron 6000" } },
        { 39593, new TreasureMapInfo { ItemId = 39593, Name = "Potentially Special Timeworn Map", Tier = MapTier.Party, MinLevel = 90, Expansion = "EW", HasDungeon = true, Category = MapCategory.GuaranteedPortal, Status = ImplementationStatus.WIP, DungeonTerritoryId = 1000, InstanceName = "The Excitatron 6000", SecondInstanceName = "The Shifting Gymnasion Agonon", SecondTerritoryId = 1123 } },
        { 39918, new TreasureMapInfo { ItemId = 39918, Name = "Conceivably Special Timeworn Map", Tier = MapTier.Party, MinLevel = 90, Expansion = "EW", HasDungeon = true, Category = MapCategory.GuaranteedPortal, Status = ImplementationStatus.WIP, DungeonTerritoryId = 1000, InstanceName = "The Excitatron 6000", SecondInstanceName = "The Shifting Gymnasion Agonon", SecondTerritoryId = 1123 } },
        ...
        { 39592, new TreasureMapInfo { ItemId = 39592, Name = "Timeworn Br'aaxskin Map", Tier = MapTier.Party, MinLevel = 100, Expansion = "DT", HasDungeon = true, Category = MapCategory.Roulette, Status = ImplementationStatus.WIP, DungeonTerritoryId = 1209, InstanceName = "Cenote Ja Ja Gural" } },
        { 43557, new TreasureMapInfo { ItemId = 43557, Name = "Timeworn Br'aaxskin Map", Tier = MapTier.Party, MinLevel = 100, Expansion = "DT", HasDungeon = true, Category = MapCategory.Roulette, Status = ImplementationStatus.WIP, DungeonTerritoryId = 1209, InstanceName = "Cenote Ja Ja Gural" } },
        { 46185, new TreasureMapInfo { ItemId = 46185, Name = "Timeworn Gargantuaskin Map", Tier = MapTier.Party, MinLevel = 100, Expansion = "DT", HasDungeon = true, Category = MapCategory.Roulette, Status = ImplementationStatus.WIP, DungeonTerritoryId = 1279, InstanceName = "Vault Oneiron" } },

        // Thief's Map
        { 4574, new TreasureMapInfo { ItemId = 4574, Name = "Thief's Map", Tier = MapTier.Solo, MinLevel = 50, Expansion = "ARR", HasDungeon = false, Category = MapCategory.Outdoor, Status = ImplementationStatus.Implemented, DungeonTerritoryId = 725 } },
    };
